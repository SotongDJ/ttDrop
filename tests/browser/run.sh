...
FAIL=0
for test in upload.test.mjs upload-resume.test.mjs download-resume.test.mjs folder-upload.test.mjs cancel.test.mjs fileops.test.mjs fileops-disabled.test.mjs zip-download.test.mjs inline-view.test.mjs; do
    echo "=== $test ==="
