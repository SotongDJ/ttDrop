/* ttDrop upload worker: chunked, parallel, resumable via OPFS staging.
 *
 * Messages in:
 *   {cmd:"upload", key, file, chunkSize, concurrency} — stage into OPFS
 *     (when available), then transfer.
 *   {cmd:"resume", key, concurrency} — continue a transfer whose bytes
 *     are already staged in OPFS (e.g. after a page reload).
 * Messages out:
